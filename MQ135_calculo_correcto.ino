...
float temperature = 22.4; // Assume current temperature. Recommended to measure with DHT22
float humidity = 34.0; // Assume current humidity. Recommended to measure with DHT22
